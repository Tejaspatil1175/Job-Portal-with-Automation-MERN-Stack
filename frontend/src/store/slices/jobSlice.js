...
export const fetchJobs =
  ...
  async (dispatch) => {
    try {
      ...
      let link = "https://mern-stack-jobvista-automation.onrender.com/api/v1/job/getall?";
      let queryParams = [];
      if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://mern-stack-jobvista-automation.onrender.com/api/v1/job/get/${jobId}`,
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://mern-stack-jobvista-automation.onrender.com/api/v1/job/post`,
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://mern-stack-jobvista-automation.onrender.com/api/v1/job/getmyjobs`,
      { withCredentials: true }
    );
